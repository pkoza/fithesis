...
\thesissetup{
    ...
    keywords      = {digitalizácia dokumentov, webový portál, kultúrne dedičstvo, indexácia},
    TeXkeywords   = {digitalizácia dokumentov, webový portál, kultúrne dedičstvo, indexácia},
}
\thesislong{abstract}{
    Popsat principy digitalizace a publikování objektů kulturního dědictví. Zaměřit se na tuto problematiku zejména z pohledu regionálních institucí v České republice. Popsat a analyzovat možnosti využití technologie Liferay Portal pro zpracování a publikování záznamů o objektech kulturního dědictví.
}
\thesislong{thanks}{
Ďakujem
}
